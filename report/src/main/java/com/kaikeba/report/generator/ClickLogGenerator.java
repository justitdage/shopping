package com.kaikeba.report.generator;

import com.alibaba.fastjson.JSONObject;
import com.kaikeba.report.bean.ClickLog;
import com.kaikeba.report.send.KafkaMessageSend;
...
public class ClickLogGenerator {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            KafkaMessageSend.send("http://localhost:8888/ReportApplication/receiveData", jonstr);
        }
    }
}
